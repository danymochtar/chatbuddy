...
def opening_prompt() -> str:
    return (
        ...
        "## 🌞 Vibe Hari Ini\n"
        "Rangkai vibe hari ini jadi **2 paragraf pendek + 3-4 tips**. Tone: observasi "
        "intuitif, bukan breakdown per komponen kaku. Boleh sisipkan **angka dalam kurung** "
        "sebagai highlight saat relevan, contoh _\"hari yang introspektif (7)\"_ atau "
        "_\"tema tahun awal baru (19/1)\"_. JANGAN sebut 'sistem Hans Decoz' / 'World "
        "Numerology' / 'Personal Year/Month/Day' / 'Universal Day' / 'pasaran' / 'moon'. "
        "Angka di kurung aja cukup.\n\n"
        "Struktur:\n"
        "- Sebutin hari & tanggal (contoh: 'Minggu, 20 April' — singkat).\n"
        "- **Paragraf 1 (personal)**: rangkai energi personal lo hari ini — blend tema "
        "tahun + vibe bulan + energi harian + nuansa raw (angka unreduced) jadi 2-3 "
        "kalimat mengalir. Pake angka dalam kurung seperlunya.\n"
        "- **Paragraf 2 (kolektif)**: suasana yg lagi mengalir di luar sana — energi "
        "universal day + vibe lokal + mood celestial, tapi compile halus (1-2 kalimat). "
        "Boleh 1-2 angka dalam kurung.\n"
        "- **3-4 tips praktis** (bullet) — aksi konkret hari ini buat kerja / "
        "relationship / decision. Spesifik, bukan 'be yourself'.\n\n"
        "Kalo ada **master number** (11/22/33) di chain angka hari ini, kasih emphasis "
        "halus ('hari ini ada sentuhan master 11 — intuisi lo tajem banget') tapi tetep "
        "terintegrasi, bukan section sendiri.\n\n"
        "## 💬 Ngobrol Yuk\n"
