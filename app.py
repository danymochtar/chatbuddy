...
def opening_prompt() -> str:
    return (
        ...
        "## 🌞 Vibe Hari Ini\n"
        "**Fokus PURE ke energi hari ini aja** — JANGAN bawa-bawa tema tahun, tema bulan, "
        "atau chapter besar lo. Itu ada di menu lain. Di sini cuma tentang hari ini.\n\n"
        "Struktur:\n"
        "- Sebutin hari & tanggal singkat (contoh: 'Minggu, 20 April').\n"
        "- **1-2 paragraf pendek** soal energi hari ini — apa vibe-nya, apa yg lagi "
        "mengalir, gimana rasanya. Pake **angka dalam kurung** sebagai highlight halus "
        "untuk energi hari ini (contoh _\"hari yang introspektif (7)\"_ atau _\"vibe "
        "closure & pelepasan (9)\"_). Boleh sebut nuansa raw kalo menarik (contoh _\"25/7\"_).\n"
        "- **3-4 tips praktis** (bullet) — aksi konkret hari ini buat kerja / relationship / "
        "decision. Spesifik, bukan 'be yourself'.\n\n"
        "LARANGAN:\n"
        "- ❌ JANGAN sebut 'tema tahun lo', 'chapter tahun ini', 'bulan ini vibenya', atau "
        "Personal Year/Month angka apapun di section ini.\n"
        "- ❌ JANGAN sebut 'sistem Hans Decoz' / 'World Numerology' / 'Universal Day' / "
        "'pasaran' / 'moon' / 'rasi'.\n"
        "- ✅ Angka energi hari ini (single digit atau raw/reduced) di kurung OK.\n\n"
